...
2. **A fault never costs protection.** A fault value never restricts a **protection** wish more than the default does. Cautious values may restrict comfort only: a hail opening must not stop short because of a data fault.
