...
| | |
|---|---|
| Status | Draft for review by the project owner. Nothing in the domain core is built before it is approved. |
...
**How to read it.** Statements are binding unless they are inside a box like this one:

> **Decision n — title.** A point where the project owner decides. Each has a recommendation, the reason, and the alternatives that were rejected. All decisions are collected in [section 15](#15-decisions-for-the-project-owner).
...
## 15. Decisions for the project owner
