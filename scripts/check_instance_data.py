...
class Report:
    ...
    # Listed by git but no regular file here: deleted and not yet committed,
    # or the folder of a nested checkout.
    absent: list[str] = field(default_factory=list)

    def summary(self) -> str:
        """Say how much was checked and what was skipped, and why."""
        return (
            f"checked {len(self.checked)} file(s); skipped: {len(self.binary)} "
            f"binary, {len(self.generated)} generated, {len(self.absent)} listed "
            "by git but not present as a file"
        )
