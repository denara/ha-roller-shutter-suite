...
| [H02](tasks/H02-runtime-and-source-adapters.md) | Runtime and source adapters | guardrails 4 and 8, G3, G5 | C03, C04, H01 | ready |
...
| [C09](tasks/C09-sun-geometry-and-glass-calibration.md) (file written; started before M1 because it depends on C01 and C02 only; **in review**, pull request 43) | Sun geometry and glass calibration; one curtain edge per element, mapped per member through its vertical offset (architecture, decision 9) | C1, C2, C7 | C01 |
