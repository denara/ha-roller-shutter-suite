...
class SunDay:
    ...
    ``noon_elevation`` is the elevation of the sun at 12:00 local time. It
    tells on which side of a threshold the sun stays on a date without the
    event; a day of the almanac always has it.
    """
