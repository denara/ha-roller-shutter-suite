...
An answer that is missing from the almanac is never guessed:
:class:`ScheduleInputMissingError` says what is missing.
"""
...
def build_sun_almanac(config: WindowConfig, at: datetime, sun: Sun) -> SunAlmanac:
    ...
    of every elevation that an elevation trigger of the window names. The
